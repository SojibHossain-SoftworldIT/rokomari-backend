...
router.get(
  "/products/by",
  product_controller_1.productControllers.getProductsByCategoryandTag
);
router.post(
  "/create-product",
  ...
  (0, validateRequest_1.default)(product_validations_1.createProductZodSchema),
...
router.patch(
  ...
  (0, validateRequest_1.default)(product_validations_1.updateProductZodSchema),
  product_controller_1.productControllers.updateProduct
);
router.delete(
  "/delete-product/:id",
  product_controller_1.productControllers.deleteSingleProduct
);
